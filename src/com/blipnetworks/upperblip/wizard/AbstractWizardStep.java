 ...
 *
 * $Id: AbstractWizardStep.java,v 1.2 2009/06/22 21:21:54 jklett Exp $
 */
...
public abstract class AbstractWizardStep implements WizardStep {
	...
	/**
	 * The current view of the step. This will be displayed in the main area of
	 * the wizard. This property is bound.
	 */
	...
	/**
	 * Sets the name of this step. This will be displayed in the title of the
	 * wizard while this step is active.
	 * 
	 * @param name
	 *            the name of this step.
	 ...
	 * This may changed at any time by calling {@link #setView} and the wizard
	 ...
	 * displayed in the main section of the wizard with this step is active.
	 * This method may changed at any time and the wizard will update
	 * accordingly.
	 * 
	 * @param component
	...
	/**
	 * Marks this step as complete. The wizard will not be able to proceed from
	 ...
	 * {@link #abortBusy} to cancel any inprogress operation.
	 * 
	 * @param busy
	 *            <tt>true</tt> to mark the step as busy and disable further
	 *            user action, <tt>false</tt> to return the wizard to its normal
	 *            state.
	 */
