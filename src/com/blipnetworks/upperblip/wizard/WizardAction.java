 ...
 *
 * $Id: WizardAction.java,v 1.2 2009/06/22 21:21:54 jklett Exp $
 */
...
public abstract class WizardAction extends AbstractAction implements PropertyChangeListener {
	...
	protected WizardAction(String key, Wizard wizard) {
		super(I18n.getString("wizard." + key + ".text"));
		this.wizard = wizard;
		...
		putValue(Action.MNEMONIC_KEY, new Integer(I18n.getMnemonic("wizard." + key + ".mnemonic")));
