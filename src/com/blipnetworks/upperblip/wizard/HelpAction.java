 ...
 *
 * $Id: HelpAction.java,v 1.2 2009/06/22 21:21:54 jklett Exp $
 */
...
class HelpAction extends AbstractAction {
	...
	protected HelpAction(Wizard wizard) {
		super(I18n.getString("wizard.help.text"));
		this.wizard = wizard;
		putValue(Action.MNEMONIC_KEY, new Integer(I18n.getMnemonic("wizard.help.mnemonic")));
